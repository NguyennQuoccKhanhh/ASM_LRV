            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Bị khóa</li>
                    </ol>
                </div>
                        ...
                        <tbody>
                            @foreach ($deletedUsers as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        <img src="{{\Storage::url($item->avatar)}}" width="50px" alt="">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.compoents.users.restore', $item->id) }}">Khôi phục</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
